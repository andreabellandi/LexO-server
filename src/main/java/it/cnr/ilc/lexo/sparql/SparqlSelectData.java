...
public class SparqlSelectData {
    ...
    public static final String DATA_LEXICAL_ENTRIES
            ...
            + "   OPTIONAL { ?" + SparqlVariable.LEXICAL_ENTRY + " rdfs:label ?entryLabel . }\n"
            + "   OPTIONAL { ?" + SparqlVariable.LEXICAL_ENTRY + " ontolex:canonicalForm/ontolex:writtenRep ?entryWrittenRep . }\n"
            + "   BIND(COALESCE(?entryLabel, ?entryWrittenRep, REPLACE(STR(?" + SparqlVariable.LEXICAL_ENTRY + "), \"^.*[/#]\", \"\")) AS ?" + SparqlVariable.LABEL + ")\n"
    ...
    public static final String DATA_DICTIONARY_ENTRIES
            ...
            + "   OPTIONAL { ?_" + SparqlVariable.CHILD + " lexicog:describes [ lexinfo:partOfSpeech ?_" + SparqlVariable.DICTIONARY_ENTRY_POS + " ] }\n"
    ...
    public static final String DATA_LEXICAL_ENTRY_ELEMENTS
            ...
            + "FROM onto:explicit\n"
            + "WHERE {\n"
            + "  VALUES ?" + SparqlVariable.LEXICAL_ENTRY + " { [IRI] }\n"
    ...
    public static final String DATA_LEXICAL_ENTRY_CORE
            ...
            + "    OPTIONAL { ?" + SparqlVariable.LEXICAL_ENTRY + " rdfs:label ?entryLabel . }\n"
            + "    OPTIONAL { ?" + SparqlVariable.LEXICAL_ENTRY + " ontolex:canonicalForm/ontolex:writtenRep ?canonicalWrittenRep . }\n"
            + "    BIND(COALESCE(?entryLabel, ?canonicalWrittenRep, STRAFTER(STR(?" + SparqlVariable.LEXICAL_ENTRY + "), \"#\")) AS ?" + SparqlVariable.LABEL + ")\n"
    ...
    public static final String DATA_LEXICAL_ENTRY_INDIRECT_VARTRANS
            ...
            + "FROM NAMED onto:explicit\n"
            + "WHERE {\n"
            + "  VALUES ?" + SparqlVariable.SOURCE + " { [IRI] }\n"
            + "    OPTIONAL { ?" + SparqlVariable.REIFIED_RELATION + " vartrans:source ?" + SparqlVariable.SOURCE + " .\n"
            + "        OPTIONAL { ?" + SparqlVariable.SOURCE + " rdfs:label ?sourceEntryLabel . }\n"
            + "        OPTIONAL { ?" + SparqlVariable.SOURCE + " ontolex:canonicalForm/ontolex:writtenRep ?sourceEntryWrittenRep . }\n"
            + "        BIND(COALESCE(?sourceEntryLabel, ?sourceEntryWrittenRep, REPLACE(STR(?" + SparqlVariable.SOURCE + "), \"^.*[/#]\", \"\")) AS ?" + SparqlVariable.SOURCE_LABEL + ")\n"
    ...
    public static final String DATA_FORM_CORE
            ...
            + "FROM onto:explicit\n"
            + "WHERE {\n"
            + "  VALUES ?" + SparqlVariable.FORM + " { [IRI] }\n"
            + "   OPTIONAL { ?" + SparqlVariable.FORM + " " + SparqlPrefix.ONTOLEX.getPrefix() + "writtenRep ?" + SparqlVariable.WRITTEN_REPRESENTATION + " }\n"
            + "   OPTIONAL { ?" + SparqlVariable.FORM + " lexinfo:confidence ?confidence . }\n"
            + "    ?" + SparqlVariable.LEXICAL_ENTRY + " ?" + SparqlVariable.FORM_TYPE + " ?" + SparqlVariable.FORM + " .\n"
    ...
    public static final String DATA_LEXICAL_SENSE_DIRECT_VARTRANS
            ...
            + "SELECT ?" + SparqlVariable.PROPERTY_NAME + " ?" + SparqlVariable.LEXICAL_ENTITY + " \n"
            + "(GROUP_CONCAT(?_type;SEPARATOR=\";\") as ?" + SparqlVariable.TYPE + ")\n"
            + "?" + SparqlVariable.LABEL + " ?" + SparqlVariable.GRAPH + " ?" + SparqlVariable.LEXICAL_ENTRY + "\n"
            + "FROM NAMED onto:implicit\n"
            + "FROM NAMED onto:explicit\n"
            + "WHERE {\n"
            + "  VALUES ?" + SparqlVariable.SENSE + " { [IRI] }\n"
            ...
            + "               ?" + SparqlVariable.LEXICAL_ENTITY + " ontolex:isSenseOf ?targetEntry .\n"
            + "               OPTIONAL { ?targetEntry rdfs:label ?targetEntryLabel . }\n"
            + "               OPTIONAL { ?targetEntry ontolex:canonicalForm/ontolex:writtenRep ?targetEntryWrittenRep . }\n"
            + "               BIND(COALESCE(?targetEntryLabel, ?targetEntryWrittenRep, REPLACE(STR(?targetEntry), \"^.*[/#]\", \"\")) AS ?" + SparqlVariable.LEXICAL_ENTRY + ")\n"
            + "               OPTIONAL { "
            ...
            + "               FILTER(BOUND(?" + SparqlVariable.LEXICAL_ENTITY + "))\n"
            + "} \n"
            + "GROUP BY ?" + SparqlVariable.PROPERTY_NAME + " ?" + SparqlVariable.LEXICAL_ENTITY + " ?"
            + SparqlVariable.LABEL + " ?" + SparqlVariable.GRAPH + " ?" + SparqlVariable.LEXICAL_ENTRY + "\n"
            + "ORDER BY ?" + SparqlVariable.PROPERTY_NAME;
    ...
    public static final String DATA_LEXICAL_SENSE_INDIRECT_VARTRANS
            ...
            + "SELECT \n"
            + "?" + SparqlVariable.REIFIED_RELATION + " ?" + SparqlVariable.CATEGORY + " ?" + SparqlVariable.TYPE + " ?" + SparqlVariable.SOURCE
            + " ?" + SparqlVariable.SOURCE_LEXICAL_ENTRY + " ?" + SparqlVariable.SOURCE_LABEL + " ?" + SparqlVariable.TARGET + " ?" + SparqlVariable.TARGET_LABEL
            + " ?" + SparqlVariable.TARGET_LEXICAL_ENTRY + " ?" + SparqlVariable.NOTE + " ?" + SparqlVariable.LABEL + "\n"
            + "(GROUP_CONCAT(concat(str(?reifiedRelationPredicate),\"<>\",str(?reifiedRelationObject),\"<>\",str(?graph));SEPARATOR=\"---\") AS ?extra)\n"
            + "FROM NAMED onto:implicit\n"
            + "FROM NAMED onto:explicit\n"
            + "WHERE {\n"
            ...
            + "        FILTER(!STRSTARTS(STR(?" + SparqlVariable.TYPE + "), \"http://www.w3.org/ns/lemon/lexicog#\")) }\n"
            + "    	OPTIONAL { ?" + SparqlVariable.REIFIED_RELATION + " vartrans:target ?" + SparqlVariable.TARGET + " .\n"
            + "                                              ?" + SparqlVariable.TARGET + " ontolex:isSenseOf ?targetEntryResource .\n"
            + "                 OPTIONAL { ?targetEntryResource rdfs:label ?targetEntryLabel . }\n"
            + "                 OPTIONAL { ?targetEntryResource ontolex:canonicalForm/ontolex:writtenRep ?targetEntryWrittenRep . }\n"
            + "                 BIND(COALESCE(?targetEntryLabel, ?targetEntryWrittenRep, REPLACE(STR(?targetEntryResource), \"^.*[/#]\", \"\")) AS ?" + SparqlVariable.TARGET_LEXICAL_ENTRY + ")\n"
            + "    	         OPTIONAL { GRAPH ?gTarget { ?" + SparqlVariable.TARGET + " skos:definition ?" + SparqlVariable.TARGET_LABEL + " }\n"
            + "                             FILTER(STRSTARTS(STR(?gTarget), \"http://www.ontotext.com/explicit\")) }\n"
            + "         }\n"
            + "    	OPTIONAL { ?" + SparqlVariable.REIFIED_RELATION + " vartrans:target ? [ ontolex:isSenseOf [ rdfs:label ?" + SparqlVariable.LEXICAL_ENTRY + " ] ] }\n"
            + "                    ?" + SparqlVariable.SOURCE + " ontolex:isSenseOf ?sourceEntryResource .\n"
            + "                    OPTIONAL { ?sourceEntryResource rdfs:label ?sourceEntryLabel . }\n"
            + "                    OPTIONAL { ?sourceEntryResource ontolex:canonicalForm/ontolex:writtenRep ?sourceEntryWrittenRep . }\n"
            + "                    BIND(COALESCE(?sourceEntryLabel, ?sourceEntryWrittenRep, REPLACE(STR(?sourceEntryResource), \"^.*[/#]\", \"\")) AS ?" + SparqlVariable.SOURCE_LEXICAL_ENTRY + ")\n"
            + "    	OPTIONAL { \n"
            ...
            + "}\n"
            + "GROUP BY ?" + SparqlVariable.REIFIED_RELATION + " ?" + SparqlVariable.CATEGORY + " ?" + SparqlVariable.TYPE + " ?" + SparqlVariable.SOURCE
            + " ?" + SparqlVariable.TARGET + " ?" + SparqlVariable.TARGET_LABEL + " ?" + SparqlVariable.TARGET_LEXICAL_ENTRY
            + " ?" + SparqlVariable.SOURCE_LEXICAL_ENTRY + " ?" + SparqlVariable.SOURCE_LABEL + " ?" + SparqlVariable.NOTE + " ?" + SparqlVariable.LABEL + "\n"
            + "ORDER BY ?" + SparqlVariable.REIFIED_RELATION;
    ...
    public static final String DATA_ETYMOLOGY
            ...
            + "FROM onto:explicit\n"
            + "WHERE {\n"
            + "  VALUES ?" + SparqlVariable.ETYMOLOGY + " { [IRI] }\n"
    ...
    public static final String DATA_COMPONENT = SparqlPrefix.DCT.getSparqlPrefix() + "\n"
            ...
            + "FROM onto:explicit\n"
            + "WHERE {\n"
            + "  VALUES ?" + SparqlVariable.COMPONENT + " { [IRI] }\n"
    ...
    public static final String DATA_GENERIC_RELATION
            ...
            + SparqlPrefix.RDF.getSparqlPrefix() + "\n"
            + SparqlPrefix.OWL.getSparqlPrefix() + "\n"
            + "SELECT ?graph ?" + SparqlVariable.TARGET + " ?" + SparqlVariable.LABEL + " ?" + SparqlVariable.LINK
            + " (GROUP_CONCAT(distinct concat(str(?_type));SEPARATOR=\";\") AS ?" + SparqlVariable.TYPE + ")\n"
            + "FROM NAMED " + SparqlPrefix.ONTO.getPrefix() + "explicit\n"
            + "FROM NAMED " + SparqlPrefix.ONTO.getPrefix() + "implicit\n"
            + "   { \n"
            + "      GRAPH ?graph { <_ID_> ?" + SparqlVariable.LINK + " ?" + SparqlVariable.TARGET + " . \n"
            + "                                             FILTER (regex(str(?" + SparqlVariable.LINK + "), \"_RELATION_\")) }\n"
            + "    OPTIONAL { ?" + SparqlVariable.TARGET + " " + SparqlPrefix.RDFS.getPrefix() + "label|" + SparqlPrefix.SKOS.getPrefix() + "definition ?" + SparqlVariable.LABEL + " . }\n"
            + "    OPTIONAL { ?" + SparqlVariable.TARGET + " " + SparqlPrefix.SESAME.getPrefix() + "directType ?_type . \n"
            + "    FILTER (!regex(str(?_type), \"http://www.w3.org/2000/01/rdf-schema#|http://www.w3.org/1999/02/22-rdf-syntax-ns#|http://www.w3.org/2002/07/owl#\")) }\n"
            + "   } GROUP BY ?" + SparqlVariable.TARGET + " ?" + SparqlVariable.LABEL + " ?" + SparqlVariable.LINK + " ?graph\n"
            + "ORDER BY ?graph";
...
//            + " ?" + SparqlVariable.FORM_INSTANCE_NAME;
    ...
    public static final String DATA_FORMS_BY_LEXICAL_ENTRY
            ...
            + "   OPTIONAL { ?" + SparqlVariable.FORM + " ontolex:writtenRep ?" + SparqlVariable.WRITTEN_REPRESENTATION + " }\n"
            + "   OPTIONAL { ?" + SparqlVariable.FORM + " ontolex:phoneticRep ?" + SparqlVariable.PHONETIC_REPRESENTATION + " . }\n"
            + "   OPTIONAL { ?" + SparqlVariable.FORM + " lexinfo:confidence ?confidence . }\n"
            + "   OPTIONAL { ?" + SparqlVariable.FORM + " dct:created ?" + SparqlVariable.CREATION_DATE + " . }\n"
            + "   OPTIONAL { ?" + SparqlVariable.FORM + " dct:modified ?" + SparqlVariable.LAST_UPDATE + " . }\n"
...
//            + " ?" + SparqlVariable.FORM_INSTANCE_NAME;
    ...
    public static final String DATA_LEXICAL_CONCEPTS_CHILDREN
            ...
            + SparqlPrefix.INST.getSparqlPrefix() + "\n"
            + "SELECT DISTINCT\n"
            + "?" + SparqlVariable.CHILD + " (count(distinct ?" + SparqlVariable.GCHILD + ") as ?" + SparqlVariable.NGCHILD + ") \n"
            + "(count(distinct ?attestation) as ?" + SparqlVariable.ATTESTATIONS + ")\n"
            + "?" + SparqlVariable.LABEL + "\n"
            ...
            + "  }\n"
            + "  OPTIONAL { GRAPH ?attestationGraph { ?" + SparqlVariable.CHILD + " frac:attestation ?attestation . }\n"
            + "    FILTER(STRSTARTS(STR(?attestationGraph), \"_ATTESTATION_GRAPH_BASE_\")) }\n"
            + "}\n"
    ...
    public static final String DATA_LEXICAL_CONCEPTS_ROOT
            ...
            + "WHERE {\n"
            + "    ?search a inst:lexicalConceptIndex ;\n"
            + "      luc:query \"_LABEL_INDEX_:*\" ;\n"
            + "      luc:offset \"0\" ;\n"
            + "      luc:limit \"50000\" ;\n"
            + "      luc:entities ?" + SparqlVariable.CHILD + " .\n"
            + "  ?" + SparqlVariable.CHILD + " <_LABELPROPERTY_> ?" + SparqlVariable.LABEL + " .\n"
            + "    FILTER (lang(?" + SparqlVariable.LABEL + ") = \"_DEFAULTLANGUAGE_\") \n"
            + "    OPTIONAL { ?" + SparqlVariable.CHILD + " dct:creator ?" + SparqlVariable.LEXICAL_CONCEPT_CREATOR + " }\n"
            + "    OPTIONAL { ?" + SparqlVariable.CHILD + " dct:modified ?" + SparqlVariable.LAST_UPDATE + " }\n"
            + "    OPTIONAL { ?" + SparqlVariable.CHILD + " dct:created ?" + SparqlVariable.CREATION_DATE + " }\n"
    ...
    public static final String DATA_LEXICOGRAPHIC_COMPONENTS
            ...
            + "        OPTIONAL {?" + SparqlVariable.LEXICAL_ENTITY + " lexinfo:confidence ?" + SparqlVariable.CONFIDENCE + " . }\n"
            + "        OPTIONAL {?" + SparqlVariable.LEXICAL_ENTITY + " dct:creator ?" + SparqlVariable.CREATOR + "} .\n"
            ...
            + "        OPTIONAL {?" + SparqlVariable.LEXICAL_ENTITY + " dct:dateAccepted ?" + SparqlVariable.COMPLETION_DATE + "} .\n"
            + "        OPTIONAL {?" + SparqlVariable.LEXICAL_ENTITY + " dct:dateSubmitted ?" + SparqlVariable.REVISION_DATE + "} .\n"
    ...
    public static final String DATA_DICT_ENTRY
            = SparqlPrefix.DCT.getSparqlPrefix() + "\n"
            + SparqlPrefix.LEXINFO.getSparqlPrefix() + "\n"
            + SparqlPrefix.LOC.getSparqlPrefix() + "\n"
            + SparqlPrefix.ONTO.getSparqlPrefix() + "\n"
            ...
            + "FROM NAMED onto:implicit\n "
            + "WHERE {\n"
            + "  VALUES ?" + SparqlVariable.DICTIONARY_ENTRY + " { [IRI] }\n"
            + "  ?" + SparqlVariable.DICTIONARY_ENTRY + " sesame:directType ?_" + SparqlVariable.TYPE + " .\n"
            + "   OPTIONAL { ?" + SparqlVariable.DICTIONARY_ENTRY + " rdfs:label ?entryLabel . }\n"
            + "   OPTIONAL { ?" + SparqlVariable.DICTIONARY_ENTRY + " lexicog:describes/ontolex:canonicalForm/ontolex:writtenRep ?entryWrittenRep . }\n"
            + "   BIND(COALESCE(?entryLabel, ?entryWrittenRep, REPLACE(STR(?" + SparqlVariable.DICTIONARY_ENTRY + "), \"^.*[/#]\", \"\")) AS ?" + SparqlVariable.LABEL + ")\n"
            + "   OPTIONAL {?" + SparqlVariable.DICTIONARY_ENTRY + " lexinfo:confidence ?confidence . }\n"
 ...
 /*--------------*/
    public static final String DATA_ECD_COMPONENTS
            ...
            + SparqlPrefix.ONTOLEX.getSparqlPrefix() + "\n"
            + SparqlPrefix.DCT.getSparqlPrefix() + "\n"
            + "SELECT ?" + SparqlVariable.LEXICAL_ENTITY + " ?" + SparqlVariable.TYPE + " ?" + SparqlVariable.LABEL + " ?" + SparqlVariable.LEXICAL_ENTRY_POS + " ?" + SparqlVariable.ECD_COMPONENT + " "
            //+ "(xsd:integer(REPLACE(str(?" + SparqlVariable.PROPERTY_NAME + "), \"http://www.w3.org/1999/02/22-rdf-syntax-ns#_\", \"\")) as ?" + SparqlVariable.COMPONENT_POSITION + ") "
            + "?" + SparqlVariable.LEXICAL_ENTRY_STATUS + " ?" + SparqlVariable.LEXICAL_ENTRY_REVISOR + " ?" + SparqlVariable.COMPONENT_POSITION
            + " ?" + SparqlVariable.CREATOR + " ?" + SparqlVariable.NOTE + " ?" + SparqlVariable.CREATION_DATE + " ?" + SparqlVariable.LAST_UPDATE
            + " ?" + SparqlVariable.CHILD
            ...
            + " (COUNT(?_" + SparqlVariable.CHILD + ") AS ?" + SparqlVariable.CHILD + ")\n"
            + "FROM onto:explicit\n"
            + "WHERE { <_ID_> ?" + SparqlVariable.COMPONENT_POSITION + " ?" + SparqlVariable.ECD_COMPONENT + " .\n"
            // SparqlVariable.COMPONENT_POSITION should be different from lexicog:subComponent property
            + "    ?" + SparqlVariable.ECD_COMPONENT + " a lexicog:LexicographicComponent .\n"
            + "   OPTIONAL {?" + SparqlVariable.ECD_COMPONENT + " ?" + SparqlVariable.PROPERTY_NAME + " ?_" + SparqlVariable.CHILD + " . \n"
            ...
            + "                     lexinfo:partOfSpeech ?" + SparqlVariable.LEXICAL_ENTRY_POS + " }\n"
            + "        OPTIONAL {?lexicalEntity lexinfo:confidence ?confidence . }\n"
            + "        OPTIONAL {?" + SparqlVariable.LEXICAL_ENTITY + " lexinfo:confidence ?" + SparqlVariable.CONFIDENCE + " . }\n"
            + "        OPTIONAL {?" + SparqlVariable.LEXICAL_ENTITY + " dct:creator ?" + SparqlVariable.CREATOR + "} .\n"
            + "        OPTIONAL {?" + SparqlVariable.LEXICAL_ENTITY + " dct:created ?" + SparqlVariable.CREATION_DATE + "} .\n"
            + "        OPTIONAL {?" + SparqlVariable.LEXICAL_ENTITY + " dct:modified ?" + SparqlVariable.LAST_UPDATE + "} .\n"
            ...
            + "    }\n"
            + "} GROUP BY ?" + SparqlVariable.LEXICAL_ENTITY + " ?" + SparqlVariable.LABEL + " ?" + SparqlVariable.LEXICAL_ENTRY_POS + " ?" + SparqlVariable.ECD_COMPONENT + " "
            + "?" + SparqlVariable.LEXICAL_ENTRY_STATUS + " ?" + SparqlVariable.LEXICAL_ENTRY_REVISOR + " ?" + SparqlVariable.COMPONENT_POSITION
            + " ?" + SparqlVariable.CREATOR + " ?" + SparqlVariable.NOTE + " ?" + SparqlVariable.CREATION_DATE + " ?" + SparqlVariable.LAST_UPDATE
...
//            + " ?" + SparqlVariable.ECD_SENSE_LABEL + "";
    ...
    public static final String DATA_ECD_ENTRIES
            ...
            + "   OPTIONAL {?" + SparqlVariable.DICTIONARY_ENTRY + " vs:term_status ?" + SparqlVariable.LEXICAL_ENTRY_STATUS + "} .\n"
            + "   OPTIONAL {?" + SparqlVariable.DICTIONARY_ENTRY + " foaf:depiction ?_" + SparqlVariable.IMAGE + "} .\n"
            + "   OPTIONAL { ?" + SparqlVariable.DICTIONARY_ENTRY + " lexicog:describes [ lexinfo:partOfSpeech ?_" + SparqlVariable.DICTIONARY_ENTRY_POS + " ] }\n"
            + "   OPTIONAL {?" + SparqlVariable.DICTIONARY_ENTRY + " ?" + SparqlVariable.PROPERTY_NAME + " ?_" + SparqlVariable.CHILD + " . "
            + "      FILTER (strstarts(str(?" + SparqlVariable.PROPERTY_NAME + "), str(rdf:_)))} \n"
            + "} GROUP BY ?"
            + SparqlVariable.DICTIONARY_ENTRY + " ?"
    ...
    public static final String DATA_ECD_MORPHOLOGICAL_FORMS
            = SparqlPrefix.XSD.getSparqlPrefix() + "\n"
            + SparqlPrefix.RDF.getSparqlPrefix() + "\n"
            + SparqlPrefix.LOC.getSparqlPrefix() + "\n"
            + SparqlPrefix.LEXICOG.getSparqlPrefix() + "\n"
            ...
            + "FROM onto:explicit\n"
            + "WHERE { <_ID_> lexicog:describes ?" + SparqlVariable.LEXICAL_ENTRY + " .\n"
            + "    ?" + SparqlVariable.LEXICAL_ENTRY + " lexinfo:partOfSpeech ?" + SparqlVariable.LEXICAL_ENTRY_POS + " .\n"
            + "    OPTIONAL { ?" + SparqlVariable.LEXICAL_ENTRY + " ?" + SparqlVariable.FORM_TYPE + " ?" + SparqlVariable.FORM + " .\n"
            + "        ?" + SparqlVariable.FORM + " ontolex:writtenRep ?" + SparqlVariable.WRITTEN_REPRESENTATION + " .\n"
            + "        FILTER(regex(str(?" + SparqlVariable.FORM_TYPE + "), \"canonicalForm|otherForm\")) . \n"
            + "    }\n"
            + "    OPTIONAL { ?" + SparqlVariable.FORM + " ontolex:phoneticRep ?" + SparqlVariable.PHONETIC_REPRESENTATION + " }\n"
            + "    OPTIONAL { ?" + SparqlVariable.FORM + " skos:note ?" + SparqlVariable.NOTE + " }\n"
            + "   OPTIONAL { ?" + SparqlVariable.LEXICAL_ENTRY + " ?_intrait ?_invalue  .\n"
            + "        ?_intrait rdfs:subPropertyOf lexinfo:morphosyntacticProperty . \n"
            + "        FILTER(!regex(str(?_intrait), \"morphosyntacticProperty\")) .\n"
            + "        FILTER(!regex(str(?_intrait), \"partOfSpeech\")) .\n"
            + "    }\n"
            + "    BIND ( IF (BOUND (?_intrait), ?_intrait, \"none\" )  as ?intrait  )\n"
            + "    BIND ( IF (BOUND (?_invalue), ?_invalue, \"none\" )  as ?invalue  ) \n"
            + "   OPTIONAL { ?" + SparqlVariable.FORM + " ?_trait ?_value  .\n"
            + "        ?_trait rdfs:subPropertyOf lexinfo:morphosyntacticProperty . \n"
            + "        FILTER(!regex(str(?_trait), \"morphosyntacticProperty\")) .\n"
            + "    }\n"
    ...
    public static final String DATA_ECD_ENTRY
            ...
            + "WHERE {\n"
            + "  VALUES ?" + SparqlVariable.DICTIONARY_ENTRY + " { [IRI] }\n"
            + "  ?" + SparqlVariable.DICTIONARY_ENTRY + " sesame:directType|lexicog:describes/sesame:directType ?_" + SparqlVariable.TYPE + " .\n"
            + "   OPTIONAL { ?" + SparqlVariable.DICTIONARY_ENTRY + " rdfs:label ?entryLabel . }\n"
            + "   OPTIONAL { ?" + SparqlVariable.DICTIONARY_ENTRY + " lexicog:describes/ontolex:canonicalForm/ontolex:writtenRep ?entryWrittenRep . }\n"
            + "   BIND(COALESCE(?entryLabel, ?entryWrittenRep, REPLACE(STR(?" + SparqlVariable.DICTIONARY_ENTRY + "), \"^.*[/#]\", \"\")) AS ?" + SparqlVariable.LABEL + ")\n"
            + "   OPTIONAL {?" + SparqlVariable.DICTIONARY_ENTRY + " lexinfo:confidence ?confidence . }\n"
    ...
    public static final String DATA_ECD_MEANING
            ...
            + "   OPTIONAL { ?" + SparqlVariable.DICTIONARY_ENTRY + " rdfs:label ?dictionaryEntryRdfsLabel . }\n"
            + "   OPTIONAL { ?" + SparqlVariable.LEXICAL_ENTRY + " ontolex:canonicalForm/ontolex:writtenRep ?dictionaryEntryWrittenRep . }\n"
            + "   BIND(COALESCE(?dictionaryEntryRdfsLabel, ?dictionaryEntryWrittenRep, REPLACE(STR(?" + SparqlVariable.DICTIONARY_ENTRY + "), \"^.*[/#]\", \"\")) AS ?" + SparqlVariable.DICTIONARY_ENTRY_LABEL + ")\n"
