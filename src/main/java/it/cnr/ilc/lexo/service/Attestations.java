...
public class Attestations extends Service {
    ...
    @ApiOperation(value = "Observable attestations retrieval",
            notes = "This method returns a paginated list of one observable's attestations across all per-text graphs; an optional JSON filter supports nested AND/OR conditions on attestation creators, text metadata, and observable types")
    ...
    @ApiOperation(value = "Attestation locus update",
            notes = "This method changes the Unicode code-point interval of one attestation, recalculates the value from nif:isString, and updates only an unshared locus generated by LexO")
    ...
    @ApiOperation(value = "Attestation observable batch update",
            notes = "This method atomically replaces the inverse frac:attestation link for one or more attestations in one per-text graph")
    ...
    @ApiOperation(value = "Text attestations retrieval",
            notes = "This method returns a paginated list of the attestations stored for one text, including observable display labels and NIF locus data; an optional JSON filter supports nested AND/OR conditions on attestation creators, text metadata, and observable types; attestation descriptions are not included")
